...
let taskSources = null;

let taskLifecycleStore = demoStore;
if (taskSourcesJson) {
  try {
    ...
    if (githubToken) {
      ...
      taskLifecycleStore.listMyTasks = demoStore.listMyTasks.bind(demoStore);
      taskLifecycleStore.getTask = demoStore.getTask.bind(demoStore);
      taskLifecycleStore.getTaskCiStatus = demoStore.getTaskCiStatus.bind(demoStore);
      taskLifecycleStore.getTaskReviewFeedback = demoStore.getTaskReviewFeedback.bind(demoStore);
      taskLifecycleStore.shipTask = demoStore.shipTask.bind(demoStore);
      taskLifecycleStore.rollbackTask = demoStore.rollbackTask.bind(demoStore);
    }
  } catch {
