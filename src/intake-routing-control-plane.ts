...
export class RoutingControlPlane {
  ...
  private routeSnapshot(snapshot: ProviderIssueSnapshot, ruleSet: RoutingRuleSet): {
    ...
    const providerMapping = this.resolveProviderAssigneeMapping(snapshot, ruleSet);
  ...
  private resolveProviderAssigneeMapping(snapshot: ProviderIssueSnapshot, ruleSet: RoutingRuleSet):
    | { kind: "none" }
